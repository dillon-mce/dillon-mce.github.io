...
The answer for my input was `85296` and it takes about 40 milliseconds to find it using the Swift script method described in [my AoC Setup post]({{< ref "2018-12-10-Advent-of-Code-2018-Setup" >}}).
